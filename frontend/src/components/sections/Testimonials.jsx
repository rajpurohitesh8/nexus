...
export function Testimonials() {
  ...
  return (
    <section
      id="testimonials"
      className="py-32 relative bg-background border-y border-white/5 overflow-hidden perspective-[1000px]"
    >
        ...
        >
          ...
          <AnimatePresence mode="popLayout">
            ...
            >
              ...
              <p className="text-lg font-display text-white mb-6 line-clamp-3">
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <div className="font-bold text-white">
                    {TESTIMONIALS[currIdx].author}
                  </div>
                  <div className="text-sm text-primary">
                    {TESTIMONIALS[currIdx].role}
                  </div>
                </div>
              </div>
            </motion.div>
