...
import { contactFormSchema, type ContactFormValues, useContactSubmission } from "@/hooks/use-contact";
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-white/60 text-lg mb-12 max-w-md">
              Whether you need a revolutionary web application or a complete digital transformation, our engineers are ready to execute your vision.
            </p>
            
            <div className="space-y-8">
              <div>
                <h4 className="text-white/40 text-sm font-semibold uppercase tracking-widest mb-2">Email</h4>
                <a href="mailto:hello@nexus-agency.dev" className="text-2xl text-white hover:text-primary transition-colors">
                  hello@nexus-agency.dev
                </a>
              </div>
              <div>
                <h4 className="text-white/40 text-sm font-semibold uppercase tracking-widest mb-2">Location</h4>
